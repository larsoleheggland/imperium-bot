...
class SimpleCardDeckList extends StatefulWidget {
  BotCubit botCubit;
  List<GameCard> cards;
  bool compact;

  SimpleCardDeckList(this.botCubit, this.cards, {this.compact = false});

  @override
  State<StatefulWidget> createState() =>
      _SimpleCardDeckListState(this.botCubit, cards, compact: compact);
}

class _SimpleCardDeckListState extends State<SimpleCardDeckList> {
  BotCubit botCubit;
  List<GameCard> cards;
  bool compact;
  _SimpleCardDeckListState(this.botCubit, this.cards, {this.compact = false});
