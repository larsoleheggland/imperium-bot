...
class CardFormInputScreen extends StatefulWidget {
  final CardAcquireType acquireType;
  final List<CardType> cardType;
  BotCubit botCubit;

  CardFormInputScreen(this.botCubit, this.acquireType, this.cardType,
      {Key? key})
      : super(key: key);

  @override
  _CardFormInputScreenState createState() =>
      _CardFormInputScreenState(botCubit, acquireType, cardType);
}

class _CardFormInputScreenState extends State<CardFormInputScreen> {
  final CardAcquireType acquireType;
  ...
  _CardFormInputScreenState(this.botCubit, this.acquireType, this.cardTypes) {
